...
def set_lang(req):
    language = req.data.get("language", "zh-Hans")
    if language == "zh-Hans":
        # req.session['_language'] = "zh-hans"
        settings.LANGUAGE_CODE = 'zh-Hans'
    else:
        # req.session['_language'] = "en"
...
def product_list(req):
    ...
    if product_type_id == '1' or product_type_id is None:
        ...
        product_lists = models.ChfProduct.objects.filter(is_enable=True, product_type=product_type_id)
