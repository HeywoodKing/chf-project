# Generated by Django 2.2.2 on 2019-06-27 12:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brief', models.CharField(max_length=120, verbose_name='摘要')),
                ('content', models.TextField(blank=True, default=None, null=True, verbose_name='内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort', models.IntegerField(default=0, verbose_name='排序')),
                ('is_enable', models.BooleanField(default=True, verbose_name='是否启用')),
                ('about', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='about_resource', related_query_name='about', to='home.ChfAbout', verbose_name='品牌介绍')),
            ],
            options={
