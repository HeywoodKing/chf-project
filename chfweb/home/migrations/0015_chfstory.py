    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_content', models.TextField(default='', max_length=200, verbose_name='短板故事')),
                ('long_title', models.CharField(default='', max_length=80, verbose_name='长板故事标题')),
                ('long_content', models.TextField(default='', max_length=3000, verbose_name='长板故事')),
