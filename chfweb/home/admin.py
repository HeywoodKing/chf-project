...
admin.site.index_title = _('欢迎使用春和方后台管理系统')
admin.site.site_title = _('春和方后台管理系统')
admin.site.site_header = _('春和方后台管理系统')
...
# 秦始皇故事
@admin.register(models.ChfStory)
class ChfStoryAdmin(admin.ModelAdmin):
